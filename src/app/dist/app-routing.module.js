...
var routes = [
    ...
    { path: 'App', component: login_component_1.LoginComponent },
    { path: 'Computer', component: computer_list_component_1.ComputerListComponent },
    { path: 'AddComputer', component: computer_add_component_1.ComputerAddComponent },
    { path: 'test', component: test_component_1.TestComponent },
    { path: 'App/bill', component: HoaDon_component_1.HoaDonComponent },
    { path: 'detail', component: computer_detail_component_1.ComputerDetailComponent },
