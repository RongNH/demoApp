...
var HoaDonComponent = /** @class */ (function() {
    ...
    HoaDonComponent.prototype.ngOnInit = function() {
        ...
        this.route.queryParams.subscribe(function(params) {
            ...
            _this.checkNumber(_this.Img.length);
    ...
    HoaDonComponent.prototype.Export2Doc = function(element, filename) {
        if (filename === void 0) { filename = this.MTS + '-' + this.Computer; }
    ...
    HoaDonComponent.prototype.checkNumber = function(a) {
        if (a % 2 == 0) {
    ...
    __decorate([
        core_1.Input()
    ], HoaDonComponent.prototype, "tutorial");
    __decorate([
        core_1.Output()
    ], HoaDonComponent.prototype, "refreshList");
