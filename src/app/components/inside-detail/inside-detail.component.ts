...
import { CardInsideService } from 'src/app/services/computer.service';
import Done from 'src/app/models/Done';
import Tutorial from 'src/app/models/cardInside';
...
export class InsideDetailComponent implements OnInit, OnChanges {
  ...
  constructor(private tutorialService: CardInsideService, private modalService: NgbModal, private afStorage: AngularFireStorage, private cardDoneService: CardDoneService) { }
