...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(firebaseService, modalService) {
    ...
    LoginComponent.prototype.open = function (content) {
        var _this = this;
        this.modalService.open(content, { size: 'md' }).result.then(function (result) {
    ...
    LoginComponent.prototype.OnSignin = function (email, password) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.firebaseService.signin(email, password)];
                    case 1:
                        _a.sent();
                        if (this.firebaseService.isLoggedIn)
                            this.isSignedIn = true;
